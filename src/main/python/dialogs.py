...
class Ui_AboutPage(object):
    def setupUi(self, AboutPage):
        ...
        AboutPage.setFixedSize(350, 215)
        font = QtGui.QFont()
        ...
        self.idendity = QtWidgets.QLabel(self.gridLayoutWidget)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        self.idendity.setFont(font)
        self.idendity.setText("@codernayeem")
        self.gridLayout.addWidget(self.idendity, 1, 1, 1, 1)
        ...
        self.name.setGeometry(QtCore.QRect(90, 16, 250, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
